...
export type RecipientRowFragment = {
  __typename: 'RecipientNode';
  id: string;
  name: string;
  toAddress: string;
  notificationType: Types.NotificationTypeNode;
  auditLogs: Array<{
    __typename: 'LogNode';
    datetime: string;
    id: string;
    recordId?: string | null;
    recordType: Types.LogNodeType;
    user?: { __typename: 'UserAccountNode'; username: string } | null;
  }>;
};
...
export type RecipientsQueryVariables = Types.Exact<{
  ...
  sort?: Types.InputMaybe<
    Array<Types.RecipientSortInput> | Types.RecipientSortInput
  >;
}>;
...
export type DeleteRecipientMutation = {
  __typename: 'FullMutation';
  deleteRecipient: { __typename: 'DeleteResponse'; id: string };
};
...
export function getSdk(
  ...
  return {
    Recipients(
      variables?: RecipientsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RecipientsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<RecipientsQuery>(RecipientsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Recipients',
    ...
    createRecipient(
      variables: CreateRecipientMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateRecipientMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<CreateRecipientMutation>(
    ...
    deleteRecipient(
      variables: DeleteRecipientMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeleteRecipientMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DeleteRecipientMutation>(
