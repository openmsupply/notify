...
export type UserAccountRowFragment = { __typename: 'UserAccountNode', id: string, username: string, email?: string | null, displayName: string, permissions: Array<Types.PermissionNode>, nickname?: string | null, auditLogs: Array<{ __typename: 'LogNode', datetime: string, id: string, recordId?: string | null, recordType: Types.LogNodeType, user?: { __typename: 'UserAccountNode', username: string } | null }> };
