...
mod user_account_update_tests {
    ...
    use crate::user_account::create::create_user_account;
    use crate::user_account::create::CreateUserAccount;
    use crate::user_account::update::update_user_account;
    ...
    async fn user_account_service_update_success() {
        ...
        // Update display name
        let updated_user_account = update_user_account(
            &context,
            UpdateUserAccount {
                id: "id1".to_string(),
        ...
        let _updated_user_account = update_user_account(
            &context,
            UpdateUserAccount {
                id: "id1".to_string(),
                username: None,
