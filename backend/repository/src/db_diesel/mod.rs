...
mod notification_config_recipient;
mod notification_config_recipient_list;
mod notification_config_recipient_list_row;
mod notification_config_recipient_row;
...
pub use notification_config_recipient::*;
pub use notification_config_recipient_list::*;
pub use notification_config_recipient_list_row::*;
pub use notification_config_recipient_row::*;
pub use notification_config_row::*;
pub use recipient::*;
pub use recipient_list::*;
pub use recipient_list_member::*;
pub use recipient_list_member_row::*;
pub use recipient_list_row::*;
